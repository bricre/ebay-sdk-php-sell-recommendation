# (Unofficial) eBay API client (PHP) - Sell / Recommendation
...
Starting from version 1.1.0, this project will match according eBay API's versioning. Should you found a matching 
...
Client::configure(
    new \GuzzleHttp\Client([
        'base_uri' => 'https://api.ebay.com/sell/recommendation/v1/',
        'headers'=>[
